	 ...
	 <form class="form">
	   <h1>會員資料</h1>
	    <div class="form-group">
	     <label for="exampleInputEmail1">E-mail：<%=email%></label>
	   </div>
	    <div class="form-group">
	      <label>姓名：<%=id%></label>
	    </div>
	     ...
	     <div class="form-group">
	       <label>生日：<%=birth%></label>
              ...
              <center><a href="member1.jsp"><BUTTON  class="btn"><h1>修改資料</h1></button></a></center>
  </div>
