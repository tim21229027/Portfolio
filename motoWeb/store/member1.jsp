...
%>
  <div class="member-form1">
	 <form class="form" action="update2.jsp" method="POST">
	   <h1>會員資料</h1>
	    <div class="form-group">
	     <label for="exampleInputEmail1">Email：<%=email%></label>
	   </div>
	    <div class="form-group">
	      <label>姓名：<input type="text" name="new_id" value="<%=id%>"></label>
	    </div>
	     <div class="form-group">
	       <label>電話：</label>
	         <input type="text" class="form-control" id="phone" name="new_number" value="<%=number%>">
	    </div>
	     <div class="form-group">
	       <label>生日：</label>
