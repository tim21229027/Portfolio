...
<%
if(session.getAttribute("email") != null ){
    sql = "SELECT * FROM `customer` WHERE `email`='" +session.getAttribute("email")+"';"; 
...
<div class="member-form1">
  <form class="form" action="update.jsp" method="POST">
    ...
    <div class="form-group">
      <label for="exampleInputEmail1">初始密碼:</label>
      <input type="pwd" class="form-control"  id="exampleInputEmail1" name="pwd" value="<%=pwd%>" aria-describedby="emailHelp" required  readonly>
    </div>
    <div class="form-group">
      <label for="exampleInputPassword1">更改密碼:</label>
      <input type="text" class="form-control" value="" name="new_pwd"id="exampleInputPassword1" required>
    </div>
