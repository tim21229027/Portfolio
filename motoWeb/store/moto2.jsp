...
%>
  ...
  <div class="content">
    <div class="kind">
      <h1> Suzuki GSX-R150</h1>
    </div>
    <div class="imgtxt">
      <div class="slideshow-container">
        <a class="prev" onclick="plusSlides(-1)">&#10094;</a>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto8.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto801.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto802.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto803.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto804.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto805.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto806.jpg">
        </div>
...
%>
    ...
    <div class="chara">
      <div class="pei">
        <h3>配備:</h3>
        <h3>LED大燈/進化引擎科技/先進電子燃油噴射系統/高性能雙出口排氣管/全液晶儀表板/光環免鑰匙智慧啟動系統/一鍵啟動智能開關/雙閃警示燈/290mm 浪花碟盤+ABS系統/高效能多連桿懸吊系統</h3>
      </div>
      <div class="ter">
        <h3>特色:</h3>
        <h3>SUZUKI GSX-R 系列在過去30年中，全球銷售早已突破百萬台，已經成為跑車的代名詞，GSX-R 系列車種都是 SUZUKI 工程師投注生命與熱情，將 GSX-R 當作生命中一部分來創造，造就每一台 GSX-R
          車種在不同級距成為無法撼動的地位，GSX-R150 輕量化車身搭載強悍動力引擎，將帶給你同級距最強，擁有R之靈魂的最強輕檔跑車。</h3>
      </div>
    </div>

    <hr>
    <div class="video">
      <iframe width="1000" height="600" src="https://www.youtube.com/embed/BDNH9z0mx7Q" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen></iframe>
    </div>
    <hr>
	<form name="form1" method="post" action="board2.jsp" >
    <div class="content2">
      <div class="comment">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           /*使用getRow()查詢筆數
		   sql="SELECT * FROM `guestbook2`"; //算出共幾筆留言
           ...
           */
		   //使用COUNT()查詢筆數
		   sql="SELECT COUNT(*) FROM `guestbook2`"; //算出共幾筆留言
           ResultSet rs=con.createStatement().executeQuery(sql);
...
//Step 5: 顯示結果 
           ...
           //遞減排序, 讓最新的資料排在最前面
           sql="SELECT * FROM `guestbook2` ORDER BY `GBNO` DESC LIMIT ";
           sql+=start_record+",5";

// current_page... SELECT * FROM `guestbook` ORDER BY `GBNO` DESC LIMIT
//      current_page=1: SELECT * FROM `guestbook2` ORDER BY `GBNO` DESC LIMIT 0, 5
//      current_page=2: SELECT * FROM `guestbook2` ORDER BY `GBNO` DESC LIMIT 5, 5
//      current_page=3: SELECT * FROM `guestbook2` ORDER BY `GBNO` DESC LIMIT 10, 5
...
<%
			   ...
			   out.print("<a href='moto2.jsp?page="+i+"'>"+i+"</a>"); //&nbsp;html的空白
