    ...
    <div class="imgtxt">
      <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          <img class="product" src="home/homemoto10.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1001.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1002.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1003.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1004.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1005.jpg">
        </div>
...
if( session.getAttribute("email") != null ){
		...
		%>
			 <a href="honda.jsp"><input type="button" class="but" value="立即租車"></a>
...
%>
    ...
    <div class="chara">
      <div class="pei">
        <h3>配備:</h3>
        <h3>全車線條充滿運動街車感/承襲CB系的直列四缸引擎/SFF倒立式前叉/Neo Sports Café 家族式頭燈/儀表可顯示檔位、時速、轉速與油量等資訊/全車採用LED燈具
        </h3>
      </div>
      <div class="ter">
        <h3>特色:</h3>
        <h3>潛藏於科技外形下，CB650R 搭配 649cc 四汽缸引擎，具備 75hp/ 9,000 rpm 和 6.1kg-m / 8,000rpm 的輸出動力，配合著 41mm Showa SFF
          倒立式前叉、4活塞輻射卡鉗+310mm 浮動碟盤、全新設計的鋁合金輪框、滑動離合器與巡跡系統等配置，相較上世代的車款，CB650R 也採用了全新 LCD 儀表板，具備檔位顯示、升檔和峰值保持指示等功能，騎士將能從
          CB650R 上重新體驗力量、風格和性能的完美結合，感受Honda「L4 引擎」所帶來的美好。</h3>
      </div>
    </div>

    <hr>
    <div class="video">
      <iframe width="1000" height="600" src="https://www.youtube.com/embed/aTkcVm5n5ZI" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen></iframe>
    </div>
    <hr>
 	<form name="form1" method="post" action="board4.jsp" >
    <div class="content2">
      <div class="comment">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           /*使用getRow()查詢筆數
		   sql="SELECT * FROM `guestbook4`"; //算出共幾筆留言
           ...
           */
		   //使用COUNT()查詢筆數
		   sql="SELECT COUNT(*) FROM `guestbook4`"; //算出共幾筆留言
           ResultSet rs=con.createStatement().executeQuery(sql);
...
//Step 5: 顯示結果 
           ...
           //遞減排序, 讓最新的資料排在最前面
           sql="SELECT * FROM `guestbook4` ORDER BY `GBNO` DESC LIMIT ";
           sql+=start_record+",5";

// current_page... SELECT * FROM `guestbook4` ORDER BY `GBNO` DESC LIMIT
//      current_page=1: SELECT * FROM `guestbook4` ORDER BY `GBNO` DESC LIMIT 0, 5
//      current_page=2: SELECT * FROM `guestbook4` ORDER BY `GBNO` DESC LIMIT 5, 5
//      current_page=3: SELECT * FROM `guestbook4` ORDER BY `GBNO` DESC LIMIT 10, 5
...
<%
			   ...
			   out.print("<a href='moto4.jsp?page="+i+"'>"+i+"</a>"); //&nbsp;html的空白
