    ...
    <div class="imgtxt">
      <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          <img class="product" src="home/homemoto11.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1101.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1102.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1103.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1104.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1105.jpg">
        </div>
...
%>
    ...
    <div class="chara">
      <div class="pei">
        <h3>配備:</h3>
        <h3>全車線條充滿運動街車感/承襲CB系的直列四缸引擎/SFF倒立式前叉/承襲CBR系列雙鷹眼頭燈/儀表可顯示檔位、時速、轉速與油量等資訊/全車採用LED燈具</h3>
      </div>
      <div class="ter">
        <h3>特色:</h3>
        <h3>符合運動性所設計的外觀與騎士三角，CBR650R 也配備更符合運動性的倒立式懸吊、滑動離合器與全新的 LCD 儀表等機能性配備，讓騎士更易於掌況車輛動態，整體車種也較前代減少 5KG，並具備 ABS、HSTC
          巡跡等安全配備為標準配備，在體驗絕佳的運動性能，同時保有安心與樂趣並行的騎乘環境。
        </h3>
      </div>
    </div>
    ...
    <hr>
    <div class="video">
      <iframe width="1000" height="600" src="https://www.youtube.com/embed/fehV52dFMo0" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen></iframe>
    </div>
    <hr>
 <form name="form1" method="post" action="board5.jsp" >
    <div class="content2">
      <div class="comment">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           ...
           */
		   //使用COUNT()查詢筆數
		   sql="SELECT COUNT(*) FROM `guestbook5`"; //算出共幾筆留言
           ResultSet rs=con.createStatement().executeQuery(sql);
...
//Step 5: 顯示結果 
           ...
           //遞減排序, 讓最新的資料排在最前面
           sql="SELECT * FROM `guestbook5` ORDER BY `GBNO` DESC LIMIT ";
           sql+=start_record+",5";

// current_page... SELECT * FROM `guestbook5` ORDER BY `GBNO` DESC LIMIT
//      current_page=1: SELECT * FROM `guestbook5` ORDER BY `GBNO` DESC LIMIT 0, 5
//      current_page=2: SELECT * FROM `guestbook5` ORDER BY `GBNO` DESC LIMIT 5, 5
//      current_page=3: SELECT * FROM `guestbook5` ORDER BY `GBNO` DESC LIMIT 10, 5
...
<%
			   ...
			   out.print("<a href='moto5.jsp?page="+i+"'>"+i+"</a>"); //&nbsp;html的空白
