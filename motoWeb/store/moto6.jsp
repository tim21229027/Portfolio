    ...
    <div class="imgtxt">
      <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          <img class="product" src="home/homemoto12.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1201.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1202.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1203.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1204.png">
        </div>
...
%>
    ...
    <div class="chara">
      ...
      <div class="ter">
        <h3>特色:</h3>
        <h3>為了能讓騎士更輕鬆自在地穿梭在巷弄與都市，CB300R搭載了許多現代化的科技配備，包含IMU慣性偵測系統、四活塞輻射卡鉗與41mm倒立式前叉，都是行車利器，再加上全車LED，讓夜間照明與辨識度都大幅度提升。
        </h3>
      </div>
    </div>
    ...
    <hr>
    <div class="video">
      <iframe width="1000" height="600" src="https://www.youtube.com/embed/vnaE0qWAatk" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen></iframe>
    </div>
    <hr>
  <form name="form1" method="post" action="board6.jsp" >
    <div class="content2">
      <div class="comment">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           ...
           */
		   //使用COUNT()查詢筆數
		   sql="SELECT COUNT(*) FROM `guestbook6`"; //算出共幾筆留言
           ResultSet rs=con.createStatement().executeQuery(sql);
...
// current_page... SELECT * FROM `guestbook6` ORDER BY `GBNO` DESC LIMIT
//      current_page=1: SELECT * FROM `guestbook6` ORDER BY `GBNO` DESC LIMIT 0, 5
//      current_page=2: SELECT * FROM `guestbook6` ORDER BY `GBNO` DESC LIMIT 5, 5
//      current_page=3: SELECT * FROM `guestbook6` ORDER BY `GBNO` DESC LIMIT 10, 5
...
<%
			   ...
			   out.print("<a href='moto6.jsp?page="+i+"'>"+i+"</a>"); //&nbsp;html的空白
