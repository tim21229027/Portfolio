    ...
    <div class="imgtxt">
      <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          <img class="product" src="home/homemoto15.png">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1501.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1502.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1503.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1504.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1505.jpg">
        </div>
        <div class="mySlides fade">
          <img class="product" src="home/homemoto1506.jpg">
        </div>
        ...
        <div class="sss">
          <div class="good">
            <h2>好騎指數:<img src="home/fire-wheel (3).png"><img src="home/fire-wheel (3).png"><img
                src="home/fire-wheel (3).png"><img src="home/fire-wheel (3).png"></h2>
          </div>
        </div>
        <h2>排氣量:749cc</h2>
...
%>
    ...
    <div class="chara">
      <div class="pei">
        <h3>配備:</h3>
        <h3>手作皮革座墊/圓形頭/尾燈/中置多連桿後避震器/輕量化管狀車架/浪花造型碟盤與對四卡鉗</h3>
      </div>
      <div class="ter">
        <h3>特色:</h3>
        <h3>FASTER代表的是「Performance性能」，
          而SONS則蘊含了「YAMAHA Heritage傳承」之意，
          即是以復古的精神打造出性能不斷蛻變的Sport Heritage車款。</h3>
      </div>
    </div>

    <hr>
    <div class="video">
      <iframe width="1000" height="600" src="https://www.youtube.com/embed/C2oaWGkPGQo" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen></iframe>
    </div>
    <hr>
 <form name="form1" method="post" action="board9.jsp" >
    <div class="content2">
      <div class="comment">
...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           /*使用getRow()查詢筆數
		   sql="SELECT * FROM `guestbook9`"; //算出共幾筆留言
           ...
           */
		   //使用COUNT()查詢筆數
		   sql="SELECT COUNT(*) FROM `guestbook9`"; //算出共幾筆留言
           ResultSet rs=con.createStatement().executeQuery(sql);
...
//Step 5: 顯示結果 
           ...
           //遞減排序, 讓最新的資料排在最前面
           sql="SELECT * FROM `guestbook9` ORDER BY `GBNO` DESC LIMIT ";
           sql+=start_record+",5";

// current_page... SELECT * FROM `guestbook9` ORDER BY `GBNO` DESC LIMIT
//      current_page=1: SELECT * FROM `guestbook9` ORDER BY `GBNO` DESC LIMIT 0, 5
//      current_page=2: SELECT * FROM `guestbook9` ORDER BY `GBNO` DESC LIMIT 5, 5
//      current_page=3: SELECT * FROM `guestbook9` ORDER BY `GBNO` DESC LIMIT 10, 5
...
<%
			   ...
			   out.print("<a href='moto9.jsp?page="+i+"'>"+i+"</a>"); //&nbsp;html的空白
