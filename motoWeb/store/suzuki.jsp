...
%>
  ...
  <div class="content1">
    <div class="yamaha">
      <img class="yayaya" src="home/suzuki.png">
    </div>
    <div class="title">
      <a href="index.jsp">
        <h2>首頁:</h2>
  ...
  <hr>
  <form method="post" action="pay3.jsp"> 
  <%
 while(rs.next()){%>
  <div class="content2">
    <div class="search">
      <div class="sss">
        <div class="img">
          <img class="pro" src="home/s<%=rs.getString(1)%>.jpg">
        </div>
        <div class="txt">
...
else{out.print("&emsp;<input type='radio' name='suzuki_Id' value='");%><%=rs.getString(1)%><%out.print("'><b>訂購選取</b>");}%>
</h2>
