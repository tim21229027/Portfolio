...
%>
  ...
  <div class="content1">
    <div class="yamaha">
      <img class="yayaya" src="home/yamaha.png">
    </div>
    <div class="title">
      <a href="index.jsp">
        <h2>首頁:</h2>
 ...
 while(rs.next()){%>
  <div class="content2">
    <div class="search">
      <div class="sss">
        <div class="img">
          <img class="pro" src="home/y<%=rs.getString(1)%>.png" name="pro">
        </div>
        <div class="txt">
          <a href="moto<%=rs.getString(8)%>.jsp" name="moto">
...
out.println("<b>&emsp;&emsp;&emsp;無庫存</b>");}
else{out.print("&emsp;<input type='radio' name='yamaha_Id' value='");%><%=rs.getString(1)%><%out.print("'><b>訂購選取</b>");}%>
</h2>
        </div>
      </div>
    </div>
  ...
  <hr>
      	  <% }
 %>
 <center><input class='btn' type='submit' value='立即訂車'></center>
 </form>
 <hr>
  <footer>
    <div class="foot">
